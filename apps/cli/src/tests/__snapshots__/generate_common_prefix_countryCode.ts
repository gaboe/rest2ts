...
export type PostCountryCodeVerifyFetchResponse = 
| FetchResponse<void, 200> 
| ErrorResponse;

export const postCountryCodeVerifyPath = () => `/{countryCode}/verify`;

export const postCountryCodeVerify = (body: string, options?: FetchArgsOptions):
  Promise<PostCountryCodeVerifyFetchResponse> => {
    const requestData = getApiRequestData<string>(body, false);

    return apiPost(`${getApiUrl()}${postCountryCodeVerifyPath()}`, requestData, options) as Promise<PostCountryCodeVerifyFetchResponse>;
}
...
export const postCountryCodeSessionsPath = (countryCode?: string, lang?: string, type?: string) => `/${countryCode}/Sessions`;

export const postCountryCodeSessions = (countryCode?: string, lang?: string, type?: string, options?: FetchArgsOptions):
  Promise<PostCountryCodeSessionsFetchResponse> => {
    ...
    return apiPost(`${getApiUrl()}${postCountryCodeSessionsPath(countryCode)}`, requestData, options, queryParams) as Promise<PostCountryCodeSessionsFetchResponse>;
}
