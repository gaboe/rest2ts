...
> Snapshot 1
    ...
    ␊
      ␊
    	␊
        postCalculationList(requestContract: CalculationFilter, ): Observable<CalculationListItemDto[]> { ␊
          return apiPost<CalculationListItemDto[]>(this.httpClient, \`${this.baseUrl}/api/Calculation/list\`, requestContract);␊
        }␊
      ␊
    ␊
    ␊
