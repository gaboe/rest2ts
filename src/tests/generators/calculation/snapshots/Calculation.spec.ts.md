...
> Snapshot 1
    ...
    ␊
    export const deleteCalculationId = (id: number, CalculationID: number, headers = new Headers()): ␊
    	Promise<FetchResponse<EntityResult>> => {␊
    	const queryParams = {␊
    		"Calculation.ID": CalculationID␊
    	}␊
    	return apiDelete(\`${API_URL}/api/Calculation/${id}\`, headers, queryParams);␊
    }␊
    ␊
...
> Snapshot 1
    ...
    ␊
      ␊
        ...
        ␊
    ␊
        deleteCalculationId(id: number, CalculationID: number): Observable<ResponseResult<EntityResult, 200> | ResponseResult<ProblemDetails, 403>> {␊
          const queryParams = {␊
    		"Calculation.ID": CalculationID␊
    	}␊
    	␊
          return apiDelete<ResponseResult<EntityResult, 200> | ResponseResult<ProblemDetails, 403>>(this.httpClient, \`${this.baseUrl}/api/Calculation/${id}\`, queryParams);␊
        }␊
        ␊
    ␊
