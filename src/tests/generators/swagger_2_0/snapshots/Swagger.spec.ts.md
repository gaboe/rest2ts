...
> Snapshot 1
    ...
    const API_URL = "";␊
    ␊
    export const getAgendaSearch = (do_num: string, Authorization: string, headers = new Headers()): ␊
    ...
    ␊
    export const postApiUsersIsUserValid = (requestContract: LoginDataDataContract, Authorization: string, headers = new Headers()): ␊
    	Promise<FetchResponse<any>> => ␊
    	apiPost(`${API_URL}/api/ApiUsers/IsUserValid`, requestContract, headers);␊
    ␊
    export const patchCaseUpdateCaseTypeCaseNoCaseType = (caseNo: string, caseType: string, Authorization: string, headers = new Headers()): ␊
    	Promise<FetchResponse<any>> => ␊
