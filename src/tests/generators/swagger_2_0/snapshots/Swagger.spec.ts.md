...
> Snapshot 1
    ...
    ␊
      ␊
    	getAgendaSearch(do_num: string): Observable<ResponseResult<SearchResponse[], 200>> {␊
          const queryParams = {␊
    		do_num␊
    	}␊
    	␊
          return apiGet<ResponseResult<SearchResponse[], 200>>(this.httpClient, \`${API_URL}/api/Agenda/Search\`, queryParams);␊
        }␊
    ␊
        postApiUsersIsUserValid(requestContract: LoginDataDataContract, ): Observable<ResponseResult<, 200>> { ␊
          return apiPost<ResponseResult<, 200>>(this.httpClient, \`${this.baseUrl}/api/ApiUsers/IsUserValid\`, requestContract);␊
        }␊
      ␊
    ␊
        postContractEditContractSignatures(requestContract: IPA_PlexDbContext_ContractSignature[], ): Observable<ResponseResult<, 200>> { ␊
          return apiPost<ResponseResult<, 200>>(this.httpClient, \`${this.baseUrl}/api/Contract/EditContractSignatures\`, requestContract);␊
        }␊
      ␊
    ␊
        patchCaseUpdateCaseTypeCaseNoCaseType(caseNo: string, caseType: string): Observable<ResponseResult<, 200>> { ␊
          return apiPatch<ResponseResult<, 200>>(this.httpClient, \`${this.baseUrl}/api/Case/UpdateCaseType/${caseNo}/${caseType}\`, {});␊
        }␊
      ␊
    ␊
    ␊
