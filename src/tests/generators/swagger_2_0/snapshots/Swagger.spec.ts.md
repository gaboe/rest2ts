...
> Snapshot 1
    ...
    ␊
      ␊
        ...
        ␊
    ␊
        postApiUsersIsUserValid(requestContract: LoginDataDataContract): Observable<ResponseResult<object, 200>> { ␊
          return apiPost<ResponseResult<object, 200>>(this.httpClient, \`${this.baseUrl}/api/ApiUsers/IsUserValid\`, requestContract);␊
        }␊
      ␊
    ␊
