...
export const API_ROUTES = { 
	postPetPetIdUploadImage: "/pet",
	postPet: "/pet",
	putPet: "/pet",
	getPetFindByStatus: "/pet/findByStatus",
	getPetFindByTags: "/pet/findByTags",
	getPetPetId: "/pet",
	deletePetPetId: "/pet",
	postPetPetId: "/pet",
	getStoreInventory: "/store/inventory",
	postStoreOrder: "/store/order",
	getStoreOrderOrderId: "/store/order",
	deleteStoreOrderOrderId: "/store/order",
	postUserCreateWithList: "/user/createWithList",
	getUserUsername: "/user",
	deleteUserUsername: "/user",
	putUserUsername: "/user",
	getUserLogin: "/user/login",
	getUserLogout: "/user/logout",
	postUserCreateWithArray: "/user/createWithArray",
	postUser: "/user"
}
...
export const postPetPetIdUploadImage = (petId: number, headers = new Headers()): 
	...
	return apiPost(`${API_URL}/pet/${petId}/uploadImage`, {}, headers) as Promise<PostPetPetIdUploadImageFetchResponse>;
}
...
export const postPet = (requestContract: Pet, headers = new Headers()): 
	...
	return apiPost(`${API_URL}/pet`, requestContract, headers) as Promise<PostPetFetchResponse>;
}
...
export const putPet = (requestContract: Pet, headers = new Headers()): 
	...
	return apiPut(`${API_URL}/pet`, requestContract, headers) as Promise<PutPetFetchResponse>;
}
...
export const getPetFindByStatus = (status: string[], headers = new Headers()): 
	...
	return apiGet(`${API_URL}/pet/findByStatus`, headers, queryParams) as Promise<GetPetFindByStatusFetchResponse>;
}
...
export const getPetFindByTags = (tags: string[], headers = new Headers()): 
	...
	return apiGet(`${API_URL}/pet/findByTags`, headers, queryParams) as Promise<GetPetFindByTagsFetchResponse>;
}
...
export const getPetPetId = (petId: number, headers = new Headers()): 
	...
	return apiGet(`${API_URL}/pet/${petId}`, headers, {}) as Promise<GetPetPetIdFetchResponse>;
}
...
export const deletePetPetId = (petId: number, headers = new Headers()): 
	...
	return apiDelete(`${API_URL}/pet/${petId}`, headers, {}) as Promise<DeletePetPetIdFetchResponse>;
}
...
export const postPetPetId = (petId: number, headers = new Headers()): 
	...
	return apiPost(`${API_URL}/pet/${petId}`, {}, headers) as Promise<PostPetPetIdFetchResponse>;
}
...
export const getStoreInventory = (headers = new Headers()): 
	...
	return apiGet(`${API_URL}/store/inventory`, headers, {}) as Promise<GetStoreInventoryFetchResponse>;
}
...
export const postStoreOrder = (requestContract: Order, headers = new Headers()): 
	...
	return apiPost(`${API_URL}/store/order`, requestContract, headers) as Promise<PostStoreOrderFetchResponse>;
}
...
export const getStoreOrderOrderId = (orderId: number, headers = new Headers()): 
	...
	return apiGet(`${API_URL}/store/order/${orderId}`, headers, {}) as Promise<GetStoreOrderOrderIdFetchResponse>;
}
...
export const deleteStoreOrderOrderId = (orderId: number, headers = new Headers()): 
	...
	return apiDelete(`${API_URL}/store/order/${orderId}`, headers, {}) as Promise<DeleteStoreOrderOrderIdFetchResponse>;
}

export type PostUserCreateWithListFetchResponse = 
| FetchResponse<void, default> 
| ErrorResponse;

export const postUserCreateWithList = (requestContract: User[], headers = new Headers()): 
	Promise<PostUserCreateWithListFetchResponse> => {
	return apiPost(`${API_URL}/user/createWithList`, requestContract, headers) as Promise<PostUserCreateWithListFetchResponse>;
}
...
export const getUserUsername = (username: string, headers = new Headers()): 
	...
	return apiGet(`${API_URL}/user/${username}`, headers, {}) as Promise<GetUserUsernameFetchResponse>;
}
...
export const deleteUserUsername = (username: string, headers = new Headers()): 
	...
	return apiDelete(`${API_URL}/user/${username}`, headers, {}) as Promise<DeleteUserUsernameFetchResponse>;
}
...
export const putUserUsername = (requestContract: User, username: string, headers = new Headers()): 
	...
	return apiPut(`${API_URL}/user/${username}`, requestContract, headers) as Promise<PutUserUsernameFetchResponse>;
}
...
export const getUserLogin = (password: string, username: string, headers = new Headers()): 
	Promise<GetUserLoginFetchResponse> => {
	const queryParams = {
		"password": password		,
"username": username
	}
	return apiGet(`${API_URL}/user/login`, headers, queryParams) as Promise<GetUserLoginFetchResponse>;
}
...
export const getUserLogout = (headers = new Headers()): 
	...
	return apiGet(`${API_URL}/user/logout`, headers, {}) as Promise<GetUserLogoutFetchResponse>;
}
...
export const postUserCreateWithArray = (requestContract: User[], headers = new Headers()): 
	...
	return apiPost(`${API_URL}/user/createWithArray`, requestContract, headers) as Promise<PostUserCreateWithArrayFetchResponse>;
}
...
export const postUser = (requestContract: User, headers = new Headers()): 
	...
	return apiPost(`${API_URL}/user`, requestContract, headers) as Promise<PostUserFetchResponse>;
}
